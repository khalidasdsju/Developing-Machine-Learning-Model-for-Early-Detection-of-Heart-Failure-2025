...
from src.entity.config_entity import DataProfilingConfig
from src.entity.artifact_entity import DataIngestionArtifact, DataProfilingArtifact
...
class DataProfiling:
    def __init__(self, data_profiling_config: DataProfilingConfig,
        ...
        try:
            logger.info(f"{'='*20}Data Profiling log started.{'='*20}")
    ...
    def generate_profile_report(self, data: pd.DataFrame, report_file_path: str, title: str):
        ...
        """
        try:
            logger.info(f"Generating profile report: {title}")
            ...
            logger.info(f"Profile report saved at: {report_file_path}")
    ...
    def initiate_data_profiling(self) -> DataProfilingArtifact:
        ...
        try:
            ...
            logger.info(f"Data profiling artifact: {data_profiling_artifact}")
